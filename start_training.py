...
if __name__ == '__main__':
    ...
    # Class Expression Learning
    parser.add_argument("--num_individual_per_example", type=int, default=2,
                        help='Input set size for expression learning.')
    parser.add_argument("--num_of_learning_problems_training", type=int, default=100,
    ...
    # Neural related
    parser.add_argument("--neural_architecture", type=str, default='PIL',
                        help='[PIL,]')
